...
- ✅ **Educational-fidelity audit 2026-06-23** → `docs/audits/EDU-FIDELITY-2026-06-23.md`.
  ...
  **Verdict: the core pedagogy is faithfully implemented and works live** (predict-gate,
  ...
  (blocked, #14/#15); G6 editor pane clips framing comments (#25).- ✅ **Mobile README: evergreen download link (mobile `367462b`, 2026-07-03).** The "latest APK" button hardcoded the v0.3.2 asset — FIVE releases stale (pre-versionName-fix). Now /releases/latest (verified resolving to v0.3.14), with the v0.4 cut checklist teaching a STABLE asset name (tempered-studio.apk) so a one-tap /releases/latest/download/ URL works forever after. Offline list caught up (quizzes/cheatsheets/hints/Explain/Library). NO release.
