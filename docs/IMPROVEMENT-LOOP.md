...
- ✅ **Educational-fidelity audit 2026-06-23** → `docs/audits/EDU-FIDELITY-2026-06-23.md`.
  ...
  **Verdict: the core pedagogy is faithfully implemented and works live** (predict-gate,
  ...
  (blocked, #14/#15); G6 editor pane clips framing comments (#25).- ✅ **dev.23 — Q pt.2 sweep, phase 8/generics-traits-lifetimes (2026-07-04).** 9 exercises; stripped CONCEPT (incl. the trait-object walkthrough), E0599/E0106 spoilers, and Hint lines spelling the fix. 8/11 done. 71 verify. Remaining: 07b-functional-and-smart-pointers, 08-concurrency, 09-advanced. [[mobile-v04-testing-backlog]].
