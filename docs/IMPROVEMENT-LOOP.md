...
- ✅ **Educational-fidelity audit 2026-06-23** → `docs/audits/EDU-FIDELITY-2026-06-23.md`.
  ...
  **Verdict: the core pedagogy is faithfully implemented and works live** (predict-gate,
  ...
  (blocked, #14/#15); G6 editor pane clips framing comments (#25).- ✅ **dev.18 — Q pt.2 sweep, phase 3/text-and-collections (2026-07-04).** 9 exercises (Vec/String/&str/iter/HashMap/move) stripped of CONCEPT/how-to/Hint reveals; credit normalised. 3/11 phases done. 71 verify. Remaining: 04-ownership, 05/05b, 06-modules, 07/07b, 08-concurrency, 09-advanced. [[mobile-v04-testing-backlog]].
