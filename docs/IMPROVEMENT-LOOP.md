...
- ✅ **Educational-fidelity audit 2026-06-23** → `docs/audits/EDU-FIDELITY-2026-06-23.md`.
  ...
  **Verdict: the core pedagogy is faithfully implemented and works live** (predict-gate,
  ...
  (blocked, #14/#15); G6 editor pane clips framing comments (#25).- ✅ **OS color-scheme respected on first visit (`f73cd19`, 2026-07-03).** The app forced dark on everyone; now: saved choice wins → else prefers-color-scheme:light gets the (AA-clean, CI-gated) light theme → else dark. e2e +3 covering all branches via emulateMedia. Suite 49/49 zero-flake. NO APK.
