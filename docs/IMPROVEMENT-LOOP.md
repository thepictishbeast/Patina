...
- ✅ **Educational-fidelity audit 2026-06-23** → `docs/audits/EDU-FIDELITY-2026-06-23.md`.
  ...
  **Verdict: the core pedagogy is faithfully implemented and works live** (predict-gate,
  ...
  (blocked, #14/#15); G6 editor pane clips framing comments (#25).- ✅ **dev.17 — Q pt.2 sweep, phase 2/control-flow (2026-07-04).** Same strip on the 5 if/match/loop/for exercises. 2/11 phases done (basics+control-flow). Code byte-identical, 71 verify. Remaining: 03-text-and-collections … 09-advanced. [[mobile-v04-testing-backlog]].
