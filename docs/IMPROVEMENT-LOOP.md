...
- ✅ **Educational-fidelity audit 2026-06-23** → `docs/audits/EDU-FIDELITY-2026-06-23.md`.
  ...
  **Verdict: the core pedagogy is faithfully implemented and works live** (predict-gate,
  ...
  (blocked, #14/#15); G6 editor pane clips framing comments (#25).- ✅ **Android theme determinism (`ede1fe4`, 2026-07-03).** The WebView's prefers-color-scheme reporting is undefined without DayNight config (the app has none) — the new OS-default could have surprise-booted phones light. The OS branch now applies only when AndroidSeam is absent; phones stay dark unless toggled, saved choices win everywhere. e2e +1 (seam + OS-light → dark). Suite 50/50 zero-flake. NO APK.
